// <copyright file="PolicyTestHarness.cs" author="Ulf Bourelius">
...
{
    public sealed class PolicyTestHarness<TInput, TOutput, TDefinition, TCodeDefinition, TErrorDefinition> : IPolicyTestHarness<TInput, TOutput, TDefinition, TCodeDefinition, TErrorDefinition>
        ...
        where TErrorDefinition : IErrorDefinition
    {
        ...
        public PolicyTestHarness(ITestHarnessConfiguration config) { }
